...
public class Transition_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_jj4qz_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNodeList_jj4qz_f0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createConstant_jj4qz_b0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "nextStateName ");
  ...
  private EditorCell createRefCell_jj4qz_c0(EditorContext editorContext, SNode node) {
    ...
    provider.setRole("nextStateRef");
    provider.setNoTargetText("<no nextStateRef>");
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new Transition_Editor._Inline_jj4qz_a2a());
    editorCell = provider.createEditorCell(editorContext);
    if (editorCell.getRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setRole("nextStateRef");
    }
  ...
  private EditorCell createRefNodeList_jj4qz_f0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Transition_Editor.conditionsListHandler_jj4qz_f0(node, "conditions", editorContext);
  ...
  private static class conditionsListHandler_jj4qz_f0 extends RefNodeListHandler {
    public conditionsListHandler_jj4qz_f0(SNode ownerNode, String childRole, EditorContext context) {
